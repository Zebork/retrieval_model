...
# proxy2 = {'http':'http://blu.zebork.org:60876'}
# proxy3 = {'http':'http://ss2.zebork.org:60876'}
direct = None
proxy1 = None
...
def reload_done(file_dir):
    ...
    done = done + os.listdir('/Users/ZeborkFile/Documents/信工所/信息检索导论/作业/搜索引擎/Mine/news_cache_new/')
...
def get_date():
    ...
    # cache.append(today.strftime('%Y-%m-%d'))
...
def to_do_queue_save_thread():
    with open('tencent_20171216_18_31_sports_edu_house.txt','w') as f:
        while True:
...
def save_thread():
    while True:
        ...
        with open('news_cache1/' + cell[0], 'w') as f:
            f.write(cell[1])
            f.close()
